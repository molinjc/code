...
// 单向绑定
#define JCMacro_unilateralBind(obj1, property, obj2, key)  [obj1 selfProperty:@#property unilateralBindObject:obj2 keyPath:@#key];

// 双向绑定
#define JCMacro_bidirectionalBind(obj1, property, obj2, key) [obj1 selfProperty:@#property bidirectionalBindObject:obj2 keyPath:@#key]
